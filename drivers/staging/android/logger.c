...
#ifdef CONFIG_SEC_DEBUG
#define SZ_LOGGER_BUF_MAIN 32*1024 //2MB       Reclaim some RAM from logger
#define SZ_LOGGER_BUF_RADIO 32*1024 //2MBReclaim some RAM from logger
#else
#define SZ_LOGGER_BUF_MAIN 256*1024
#define SZ_LOGGER_BUF_RADIO 256*1024
#endif
#define SZ_LOGGER_BUF_EVENTS 32*1024// Reclaim some RAM from logger
#define SZ_LOGGER_BUF_SYSTEM 32*1024  //Reclaim some RAM from logger
				      ...
				      struct logger_entry *entry)
{
	...
	snprintf(log->ess_buf, ESS_MAX_BUF_SIZE, "[%5lu.%06lu][%d:%16s] %s.%03d %5d %5d %c ",
