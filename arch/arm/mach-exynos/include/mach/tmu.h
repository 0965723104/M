...
#define MIF_TH_TEMP1		90
#define MIF_TH_TEMP2		100
...
#if defined(CONFIG_EXYNOS_THERMAL) && (defined(CONFIG_SOC_EXYNOS5430) || defined(CONFIG_SOC_EXYNOS5433) || defined(CONFIG_SOC_EXYNOS3475))
